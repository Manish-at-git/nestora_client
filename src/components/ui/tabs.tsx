...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center justify-start sm:justify-center rounded-xl bg-slate-100 p-1 text-slate-500 max-w-full overflow-x-auto overscroll-x-contain no-scrollbar flex-nowrap",
      className
    )}
    {...props}
  />
